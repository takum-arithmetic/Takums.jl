...
Base.inv(t::Takum8) = Base.bitcast(Takum8,  @ccall libtakum.takum8_inversion(reinterpret(Signed, x)::Int8)::Int8)
Base.inv(t::Takum16) = Base.bitcast(Takum16,  @ccall libtakum.takum16_inversion(reinterpret(Signed, x)::Int16)::Int16)
Base.inv(t::Takum32) = Base.bitcast(Takum32,  @ccall libtakum.takum32_inversion(reinterpret(Signed, x)::Int32)::Int32)
Base.inv(t::Takum64) = Base.bitcast(Takum64,  @ccall libtakum.takum64_inversion(reinterpret(Signed, x)::Int64)::Int64)
Base.inv(t::LinearTakum8) = Base.bitcast(LinearTakum8,  @ccall libtakum.takum_linear8_inversion(reinterpret(Signed, x)::Int8)::Int8)
Base.inv(t::LinearTakum16) = Base.bitcast(LinearTakum16,  @ccall libtakum.takum_linear16_inversion(reinterpret(Signed, x)::Int16)::Int16)
Base.inv(t::LinearTakum32) = Base.bitcast(LinearTakum32,  @ccall libtakum.takum_linear32_inversion(reinterpret(Signed, x)::Int32)::Int32)
Base.inv(t::LinearTakum64) = Base.bitcast(LinearTakum64,  @ccall libtakum.takum_linear64_inversion(reinterpret(Signed, x)::Int64)::Int64)
